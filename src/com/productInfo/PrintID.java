...
//get current date and time as a String output
    ...
    static void myDrawString(Graphics g, String text, int x, int y) {
        ...
        public int print(Graphics graphics, PageFormat pageFormat,
            ...
            if (pageIndex == 0) {
	        	...
	        	/*
                    ...
                    int imageWidth=150;
                    int imageHeight=60;
                    String pathName = "images/productBarcode/"+AllUsers.prodID+".png";
                    BufferedImage read = ImageIO.read(new File(pathName));
                    g2d.drawImage(read,x,y,imageWidth,imageHeight,null);

                    String stringBuilder = "Product Name: \n" + AllUsers.productDescription + "\n" + "Product Size: \n" +
                            AllUsers.prodSize;
                    myDrawString(g2d, stringBuilder,1,80);
//                    g2d.drawString("Product Name: "+AllUsers.prodName,1,110);
//                    g2d.drawString("Product Size: "+AllUsers.prodSize,1,120);
